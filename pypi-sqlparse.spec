...
Source0  : https://files.pythonhosted.org/packages/50/26/5da251cd090ccd580f5cfaa7d36cdd8b2471e49fffce60ed520afc27f4bc/sqlparse-0.5.0.tar.gz
...
%prep
%setup -q -n sqlparse-0.5.0
cd %{_builddir}/sqlparse-0.5.0
pushd ..
cp -a sqlparse-0.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713038519
