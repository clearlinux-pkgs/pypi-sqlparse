...
Source0  : https://files.pythonhosted.org/packages/e5/40/edede8dd6977b0d3da179a342c198ed100dd2aba4be081861ee5911e4da4/sqlparse-0.5.3.tar.gz
...
%prep
%setup -q -n sqlparse-0.5.3
cd %{_builddir}/sqlparse-0.5.3
pushd ..
cp -a sqlparse-0.5.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735099412
