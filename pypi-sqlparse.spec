...
Source0  : https://files.pythonhosted.org/packages/57/61/5bc3aff85dc5bf98291b37cf469dab74b3d0aef2dd88eade9070a200af05/sqlparse-0.5.2.tar.gz
...
%prep
%setup -q -n sqlparse-0.5.2
cd %{_builddir}/sqlparse-0.5.2
pushd ..
cp -a sqlparse-0.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731596446
